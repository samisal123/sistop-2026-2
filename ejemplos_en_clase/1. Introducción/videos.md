# Videos de historia de la computación para la introducción
...
2. [Once upon a punched card](https://www.youtube.com/watch?v=BlUWg2nxCz0)
   ...
   - 03:30: Las tarjetas perforadas como "paper shufflers", comienza a
     presentar operaciones aritméticas sencillas
     - La palabra “ordenador” para referirse a una computadora, como se usa
       en España, viene de este uso
...
3. [Michigan Terminal System](https://www.youtube.com/watch?v=cO6asQjQmPM)
   (1967; el sistema mostrado se utilizó hasta 1999)

   (Principalmente los primeros cinco minutos)

4. [The mother of all demos](https://www.youtube.com/watch?v=yJDv-zdhzMY) (1968)
   ...
   (collaborative work). Engelbart's presentation was the first to publicly
   demonstrate all these elements in a single system.
   ...
   - 31:00: Presenta los dispositivos de entrada: Mouse, teclado, y teclado
     de acordes
   - 34:00: Presenta el uso del teclado de acorde (se corta por cambio de
     rollo)

5. [Altair 8800 Pong](https://www.youtube.com/watch?v=BZykunYYeQk)
